...
const testimonials = [
  { name: "Manish Parmar", text: "My case manager Mr. Can (John) Ozdemir was very professional and detailed in our initial correspondence. He is very organized and exceeds all standards of customer satisfaction and comfort. I was not nervous at all traveling from Toronto to Istanbul because I was confident that John had everything under control; from booking all appointments, picking me up from the airport and informing me of what to expect in detail. He answered all of my questions many times to make sure I understood the whole process before and after the hair transplant. I will be going back in a year to complete my 2nd session with this great team.", rating: 5 },
  { name: "Veronica J. S", text: "We had a very positive experience with the exclusive package with Turkey medical center, from the beginning to the end of our stay in Istanbul. Can picked us up at the airport and took us back to the airport on the last day. The day my husband had the hair transplant, Can was with him the whole time and took him safe back to the hotel after. He took us sightseeing exciting places and restaurants with great food the day after the operation. My husband has felt safe from he booked to operation to now, when he is home and recovering.", rating: 5 },
  { name: "Michael Mccloud", text: "If you're looking for a professional clinic for hair transplants in Istanbul, this is the one. Can the patient rep is highly communicative and professional, shows up on time and escorts you through the whole process from start to finish. This is not a transplant mill — these are highly trained and skilled medical professionals. After the initial examination, the surgery is scheduled the next morning. And you're back in the hotel that afternoon with new hair. Can't recommend enough.", rating: 5 },
  { name: "Glenn Thompson", text: "Would recommend to anyone wanting a hair transplant. You get your own local assistant who picks you up from the airport, takes you to hotel, takes you to clinic and back. My host (a fantastic chap called Can) is amazing and really puts so much effort into making sure you are okay. The value for money is amazing as the package includes hotel, transplant, additional treatments and all transport.", rating: 5 },
];
