...
const packages = [
  {
    ...
    price: "400",
    priceNote: "per implant",
    subtitle: "Surgery only · No hidden fees",
    highlight: false,
    badge: null as string | null,
    cta: "outline",
    inclusions: [
      "Titanium Dental Implant (per tooth)",
      "3D Panoramic X-Ray & Consultation",
      "Local Anaesthesia",
      "Temporary Crown (where applicable)",
      "Post-Op Medication",
  ...
  },
  {
    ...
    price: "900",
    priceNote: "single implant · all-inclusive",
  ...
  },
  {
    ...
    price: "1,500",
    priceNote: "single implant · full VIP",
...
const faqs = [
  ...
  {
    q: "When will I get my permanent crown?",
    a: "In most cases a temporary crown is fitted on the day of surgery, so you leave with a tooth. The permanent crown is placed after osseointegration — the process by which the titanium implant fuses with the jawbone — which typically takes 3 to 6 months. We coordinate the permanent crown fitting remotely with your local dentist, or you can return to Istanbul for it. Our team provides 12 months of online aftercare support throughout this process.",
  },
  {
    q: "Do I need bone grafting before a dental implant?",
    a: "Not always. Bone grafting is only required when there is insufficient bone density or volume to support the implant securely. Your suitability is determined by the 3D panoramic X-ray taken on Day 2, which gives your surgeon a precise view of your jaw structure. If your case requires bone grafting, this will be discussed with you during your online pre-consultation — before you travel — so there are no surprises on arrival.",
  },
];
...
const trustBlocks = [
  ...
  },
  {
    ...
    desc: "Every dental implant comes with an official written warranty certificate — your guarantee that we stand behind every result we deliver.",
  },
];
...
const journeySteps = [
  ...
  { num: "4", title: "Day 3 — Implant Surgery", desc: "Titanium implant placement and temporary crown fitting where applicable. Your GO stays with you throughout." },
  { num: "5", title: "Day 4–5 — Recovery & Check-Up", desc: "Post-op consultation, recovery monitoring, final care instructions provided." },
  { num: "6", title: "Return Home & Ongoing Support", desc: "Fly home confidently. 12 months of online aftercare support. Permanent crown coordination with your local dentist after osseointegration." },
];

const recoveryTimeline = [
  { val: "Next Day", label: "Return to normal activities" },
  { val: "1 Week", label: "Soft diet ends" },
  { val: "3–6 Months", label: "Osseointegration complete" },
...
export default function DentalImplantLanding() {
  ...
  const scrollToForm = () => {
    document.getElementById("di-form-box")?.scrollIntoView({ behavior: "smooth", block: "start" });
  };
  ...
  const handleEmail = async (e: React.MouseEvent) => {
    ...
    await handleFormspreeSubmit({
      ...
      _subject: `Dental Implant Inquiry — Medical Center Turkey`,
      _replyto: form.email,
    } as never);
  };
    ...
    <>
      ...
      <section className="relative min-h-screen flex items-center justify-center text-center px-5 pt-24 pb-36">
        ...
        <div className="relative max-w-4xl mx-auto w-full">
          <div className="inline-block mb-7" style={{ background: "rgba(255,255,255,0.12)", border: "1px solid rgba(255,255,255,0.35)", color: "#fff", fontSize: 12, fontWeight: 600, letterSpacing: 2, textTransform: "uppercase", padding: "8px 18px", borderRadius: 100 }}>
            Istanbul&apos;s Complete Dental Implant Experience · Since 2018
          </div>
          <h1 className="font-extrabold leading-tight text-white" style={{ fontSize: "clamp(34px, 6vw, 64px)", lineHeight: 1.1, maxWidth: 820, margin: "0 auto 24px" }}>
            Dental Implants <span style={{ color: "#A3C6CF" }}>Turkey.</span><br />
          ...
          <div className="flex justify-center mb-12">
            <svg viewBox="0 0 100 100" width="90" height="90" xmlns="http://www.w3.org/2000/svg">
              ...
              <rect x="40" y="18" width="20" height="14" rx="5" fill="rgba(163,198,207,0.35)" stroke="#A3C6CF" strokeWidth="1.5" />
              <rect x="43" y="31" width="14" height="8" rx="2" fill="rgba(163,198,207,0.25)" stroke="#A3C6CF" strokeWidth="1.2" />
              <line x1="50" y1="39" x2="50" y2="45" stroke="#A3C6CF" strokeWidth="2" />
              <rect x="44" y="45" width="12" height="32" rx="3" fill="none" stroke="#A3C6CF" strokeWidth="1.5" strokeDasharray="2.5 2" />
              <line x1="44" y1="52" x2="56" y2="52" stroke="rgba(163,198,207,0.5)" strokeWidth="1" />
              <line x1="44" y1="59" x2="56" y2="59" stroke="rgba(163,198,207,0.5)" strokeWidth="1" />
              <line x1="44" y1="66" x2="56" y2="66" stroke="rgba(163,198,207,0.5)" strokeWidth="1" />
              <ellipse cx="50" cy="78" rx="10" ry="4" fill="rgba(163,198,207,0.2)" stroke="#A3C6CF" strokeWidth="1" />
            </svg>
          </div>
          ...
          <div className="flex justify-center gap-8 mt-4 flex-wrap" ref={statsRef}>
            ...
            <div className="text-center">
              ...
              <div style={{ fontSize: 12, color: "rgba(255,255,255,0.55)", marginTop: 4 }}>Days to New Tooth</div>
            </div>
            <div className="text-center">
      ...
      <section style={{ background: "#fff", padding: "80px 20px" }}>
        <div style={{ maxWidth: 960, margin: "0 auto" }}>
            ...
            {packages.map((pkg) => (
              <div key={pkg.name} className="relative flex flex-col" style={{ background: "#fff", borderRadius: 16, border: pkg.highlight ? "2px solid #5788AC" : "1px solid rgba(87,136,172,0.18)", overflow: "hidden", boxShadow: "0 2px 12px rgba(5,57,128,0.05)", transition: "box-shadow .2s, transform .2s" }}>
                ...
                <div style={{ padding: "32px 28px 24px", background: pkg.highlight ? "#053980" : "#F4F8FB", borderBottom: "1px solid rgba(87,136,172,0.12)" }}>
                  ...
                  <div style={{ fontSize: 12, color: pkg.highlight ? "rgba(255,255,255,0.5)" : "#5788AC", marginTop: 4, fontStyle: "italic" }}>{pkg.priceNote}</div>
                  <div style={{ fontSize: 13, color: pkg.highlight ? "rgba(255,255,255,0.6)" : "#6B7C8D", marginTop: 4 }}>{pkg.subtitle}</div>
                </div>
          ...
          <div style={{ background: "#F4F8FB", border: "1px solid rgba(87,136,172,0.25)", borderRadius: 10, padding: "16px 24px", fontSize: 14, color: "#6B7C8D", marginTop: 28, textAlign: "center" }}>
            Prices shown are per implant. Multiple implant discounts available — contact us for a personalised quote. Credit card payments carry a 10% surcharge.
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-5">
            {[1, 2, 3, 4].map((n) => (
              <div key={n} style={{ borderRadius: 16, overflow: "hidden", boxShadow: "0 4px 16px rgba(5,57,128,0.08)", background: "#fff", aspectRatio: "1/1", position: "relative" }}>
                <Image
                  src="/treatments/dental-implant/before-after/dental-implant-result-1.png"
                  alt={`Dental implant before and after result ${n} — Medical Center Turkey patient`}
                  fill
      ...
      <section style={{ background: "#F4F8FB", padding: "80px 20px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          <h2 style={{ fontSize: "clamp(26px,4vw,42px)", fontWeight: 800, color: "#053980", lineHeight: 1.2, marginBottom: 14 }}>5 Days. A Complete New Smile.</h2>
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-start">
            ...
            <div>
              ...
              <p style={{ fontSize: 15, color: "rgba(255,255,255,0.55)", marginBottom: 32 }}>The most common questions from our international dental implant patients — answered honestly.</p>
            ...
            {/* Right — Form */}
            <div id="di-form-box" style={{ background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.12)", borderRadius: 16, overflow: "hidden", scrollMarginTop: "80px" }}>
              <div id="consultation" />
              <div style={{ padding: "24px 32px", borderBottom: "1px solid rgba(255,255,255,0.1)", background: "rgba(255,255,255,0.04)" }}>
                <div style={{ fontSize: 18, fontWeight: 800, color: "#fff" }}>Get Your Free Dental Consultation</div>
                ...
                <form style={{ padding: 32, display: "flex", flexDirection: "column", gap: 16 }} onSubmit={e => e.preventDefault()}>
                  ...
                  <div>
                    ...
                    <select value={form.pkg} onChange={e => setForm({ ...form, pkg: e.target.value })}
                      ...
                      <option value="Premium Package — From €400 per implant" style={{ color: "#000" }}>Premium Package — From €400 per implant</option>
                      <option value="Hassle-Free Package — From €900" style={{ color: "#000" }}>Hassle-Free Package — From €900</option>
                      <option value="Executive Package — From €1,500" style={{ color: "#000" }}>Executive Package — From €1,500</option>
                  ...
                  <div>
                    ...
                    <textarea rows={3} placeholder="Tell us how many implants you need or ask any questions..." value={form.message} onChange={e => setForm({ ...form, message: e.target.value })}
