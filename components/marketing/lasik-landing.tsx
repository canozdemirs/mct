...
const packages = [
  {
    ...
    inclusions: [
      ...
      "Pre-Op Full Eye Examination",
      "Wavefront-Guided Laser Technology",
  ...
  },
  {
    ...
    price: "2,100",
    subtitle: "All-inclusive · 3 nights stay",
    highlight: true,
    badge: "MOST POPULAR",
    cta: "gold",
    inclusions: [
...
const faqs = [
  ...
  {
    q: "What is the LASIK procedure like on surgery day?",
    a: "LASIK is a quick, painless outpatient procedure. Anaesthetic drops are applied to numb the eye. The surgeon creates a thin corneal flap, the laser reshapes the underlying corneal tissue to correct your prescription, and the flap is repositioned — naturally adhering without stitches. The entire procedure for both eyes takes approximately 15 minutes. Most patients experience improved vision within hours of surgery.",
  },
  {
    q: "What is the recovery process after LASIK?",
    a: "LASIK has one of the fastest recovery timelines of any surgical procedure. Most patients notice dramatically improved vision within 24 hours. Mild dryness, light sensitivity, and slight haziness are normal for the first few days and resolve quickly. You should avoid rubbing your eyes for 2 weeks, use the prescribed eye drops as instructed, and wear protective goggles during sleep for the first week. Full visual stabilisation occurs within 4–6 weeks.",
  },
  {
    q: "Will I achieve 20/20 vision after LASIK?",
...
const trustBlocks = [
  ...
  },
  {
    ...
    desc: "We work exclusively with board-certified eye surgeons with extensive refractive surgery experience for international patients.",
  },
];
...
const journeySteps = [
  { num: "1", title: "Free Online Consultation", desc: "Share your current prescription and any eye health history via WhatsApp or the form. We review your case, recommend a package, and answer every question — at no cost." },
  ...
  { num: "3", title: "Day 2 — Eye Examination + Surgery", desc: "Morning: a full pre-operative eye examination at our partner hospital. Afternoon: LASIK surgery on both eyes. The procedure takes approximately 15 minutes. You return to your hotel to rest and allow your vision to begin stabilising." },
  { num: "4", title: "Day 3 — Follow-Up & Departure", desc: "A follow-up appointment confirms your vision has stabilised and your eyes are healing perfectly. You can fly home the same day. Your GO accompanies you to every appointment." },
  { num: "5", title: "Return Home with Clear Vision", desc: "Most patients land home seeing more clearly than they have in years — without glasses or contact lenses. 12 months of online aftercare support from our team." },
];

const recoveryTimeline = [
  { val: "24 Hours", label: "Clear vision begins" },
  { val: "1 Week", label: "Light sensitivity resolves" },
  { val: "2 Weeks", label: "No eye rubbing period" },
...
export default function LasikLanding() {
  ...
  const scrollToForm = () => {
    document.getElementById("lasik-form-box")?.scrollIntoView({ behavior: "smooth", block: "start" });
  };
  ...
  const handleEmail = async (e: React.MouseEvent) => {
    ...
    await handleFormspreeSubmit({
      ...
      _subject: `LASIK Eye Surgery Inquiry — Medical Center Turkey`,
      _replyto: form.email,
    } as never);
  };
    ...
    <>
      ...
      <section className="relative min-h-screen flex items-center justify-center text-center px-5 pt-24 pb-36">
        ...
        <div className="relative max-w-4xl mx-auto w-full">
          ...
          <h1 className="font-extrabold leading-tight text-white" style={{ fontSize: "clamp(34px, 6vw, 64px)", lineHeight: 1.1, maxWidth: 820, margin: "0 auto 24px" }}>
            ...
            See Clearly. From Start to Finish.
          </h1>
          <p style={{ fontSize: "clamp(16px, 2vw, 19px)", color: "rgba(255,255,255,0.75)", maxWidth: 620, margin: "0 auto 44px" }}>
            You fly to Istanbul. We take care of everything else — the surgery, the hotel, the transfers, the aftercare. Life without glasses or contacts in just 3 days.
          </p>
          ...
          <div className="flex justify-center mb-12">
            <svg viewBox="0 0 100 100" width="90" height="90" xmlns="http://www.w3.org/2000/svg">
              ...
              <circle cx="50" cy="50" r="10" fill="rgba(163,198,207,0.25)" stroke="#A3C6CF" strokeWidth="1.8" />
              <circle cx="50" cy="50" r="4" fill="#A3C6CF" />
              <line x1="66" y1="34" x2="74" y2="26" stroke="#A3C6CF" strokeWidth="1.5" strokeLinecap="round" />
              <path d="M 70 26 L 74 26 L 74 30" fill="none" stroke="#A3C6CF" strokeWidth="1.5" strokeLinecap="round" />
            </svg>
          </div>
      ...
      <section style={{ background: "#fff", padding: "80px 20px" }}>
        <div style={{ maxWidth: 960, margin: "0 auto" }}>
          <div className="text-center mb-4">
            ...
            <p style={{ fontSize: 16, color: "#6B7C8D", maxWidth: 560, margin: "0 auto 52px" }}>Fixed, transparent pricing. Both eyes included. No hidden costs.</p>
          </div>
      ...
      <section style={{ background: "#fff", padding: "80px 20px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          <h2 style={{ fontSize: "clamp(26px,4vw,42px)", fontWeight: 800, color: "#053980", lineHeight: 1.2, marginBottom: 14 }}>3 Days. Life Without Glasses.</h2>
      ...
      <section style={{ background: "#F4F8FB", padding: "80px 20px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          <p style={{ fontSize: 16, color: "#6B7C8D", maxWidth: 560, marginBottom: 52 }}>Unprompted reviews from patients who trusted us with their LASIK surgery in Istanbul.</p>
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-start">
            ...
            <div>
              ...
              <p style={{ fontSize: 15, color: "rgba(255,255,255,0.55)", marginBottom: 32 }}>The most common questions from our international LASIK patients — answered honestly.</p>
            ...
            {/* Right — Form */}
            <div id="lasik-form-box" style={{ background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.12)", borderRadius: 16, overflow: "hidden", scrollMarginTop: "80px" }}>
              <div id="consultation" />
                ...
                <form style={{ padding: 32, display: "flex", flexDirection: "column", gap: 16 }} onSubmit={e => e.preventDefault()}>
                  ...
                  <div>
                    ...
                    <select value={form.pkg} onChange={e => setForm({ ...form, pkg: e.target.value })}
                      ...
                      <option value="Premium Package — From €1,600" style={{ color: "#000" }}>Premium Package — From €1,600</option>
                      <option value="Hassle-Free Package — From €2,100" style={{ color: "#000" }}>Hassle-Free Package — From €2,100</option>
                      <option value="Executive Package — From €2,900" style={{ color: "#000" }}>Executive Package — From €2,900</option>
                  ...
                  <div>
                    ...
                    <textarea rows={3} placeholder="Tell us your current prescription or ask any questions..." value={form.message} onChange={e => setForm({ ...form, message: e.target.value })}
