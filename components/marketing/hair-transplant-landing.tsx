...
const faqs = [
  ...
  },
  {
    ...
    a: "Safety is our number one priority. We work exclusively with hospitals and clinics approved by the Turkish Ministry of Health — we do not compromise on this. Turkey is one of the world's leading destinations for hair transplant procedures, with highly experienced surgeons and modern facilities at a fraction of the cost of the UK or USA. Medical Center Turkey has been operating since 2008 with over 5,000 international patients treated through our network. Every hair transplant comes with an official warranty certificate.",
  },
  {
...
const trustBlocks = [
  ...
  { icon: "🌍", title: "World's First Package System", desc: "We pioneered the all-inclusive health tourism package model in 2008. No one has more experience doing this right." },
  { icon: "📋", title: "17 Years. 5,000+ Patients.", desc: "Operating since 2008 with over 5,000 international patients from the USA, UK, and Europe. Experience you can trust." },
...
const whyMCT = [
  ...
  { icon: "★", title: "Zero Question Marks", desc: "We answer every concern before you board the plane. 17 years means we've heard every question — and we have the answers." },
  ...
  return (
    <>
      ...
      <section className="relative min-h-screen flex items-center justify-center text-center px-5 py-20">
        ...
        <div className="absolute inset-0" style={{ background: "linear-gradient(to bottom, rgba(5,57,128,0.70) 0%, rgba(5,57,128,0.85) 55%, rgba(3,30,70,0.97) 100%)" }} />
      ...
      <section style={{ background: "#fff", padding: "96px 20px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          <p style={{ fontSize: 16, color: "#6B7C8D", maxWidth: 560, marginBottom: 52 }}>Most patients arrive nervous and full of doubts. They leave confident. Because we&apos;ve spent 17 years removing every single question mark from this journey.</p>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {trustBlocks.map((b) => (
