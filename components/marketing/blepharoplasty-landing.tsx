...
const packages = [
  {
    ...
    price: "1,600",
    subtitle: "Upper or lower eyelids (2 eyelids)",
    highlight: false,
    badge: null as string | null,
    cta: "outline",
    inclusions: [
      "Blepharoplasty — 2 Eyelids (Upper or Lower)",
      "Pre-Op Blood Tests & Examination",
      "Local or General Anaesthesia",
      "1 Night Hospital Stay (if required)",
      "Post-Op Medication & Eye Drops",
  ...
  },
  {
    ...
    price: "2,100",
    subtitle: "All 4 eyelids · All-inclusive · 5 nights stay",
    highlight: true,
    badge: "MOST POPULAR",
    cta: "gold",
    inclusions: [
      "Blepharoplasty — 4 Eyelids (Upper & Lower)",
      "Pre-Op Blood Tests & Examination",
      "Local or General Anaesthesia",
      "1 Night Hospital Stay (if required)",
      "Post-Op Medication & Eye Drops",
...
const faqs = [
  ...
  {
    q: "What does blepharoplasty surgery involve?",
    a: "Blepharoplasty is performed under local anaesthesia in most cases. For upper eyelids, the incision is placed within the natural eyelid crease, making scars virtually invisible once healed. Excess skin, muscle, and fat are removed or repositioned. For lower eyelids, the incision is made just below the lash line or inside the eyelid (transconjunctival approach) to remove or redistribute fat deposits. The entire procedure for all 4 eyelids takes approximately 1.5–2 hours.",
  },
  {
    q: "What is the recovery process after blepharoplasty?",
    a: "Swelling and bruising around the eyes peak in the first 48–72 hours and then begin to resolve. Most patients feel comfortable appearing in public with sunglasses after 7–10 days. Sutures are typically removed at 5–7 days. You should avoid strenuous activity for 2–3 weeks and protect your eyes from direct sunlight. The majority of swelling resolves within 4–6 weeks, with your final, refined result fully visible at 3 months.",
  },
  {
    q: "Will there be visible scarring after blepharoplasty?",
    a: "Scarring is minimal and strategically hidden. Upper eyelid scars are placed within the natural eyelid crease and become nearly invisible once fully healed. Lower eyelid scars, when external, are positioned just below the lash line where they blend naturally. By 3–6 months, the vast majority of patients find their scars to be imperceptible.",
  },
  {
...
const trustBlocks = [
  ...
  },
  {
    ...
    desc: "We work exclusively with board-certified plastic surgeons and oculoplastic specialists with extensive eyelid surgery experience for international patients.",
  },
];
...
const journeySteps = [
  ...
  { num: "3", title: "Day 2 — Pre-Op Consultation", desc: "Full examination, blood tests, and surgical plan finalised with your board-certified surgeon. Upper eyelids, lower eyelids, or all 4 — confirmed based on your goals." },
  { num: "4", title: "Day 3 — Surgery", desc: "Blepharoplasty performed under local or general anaesthesia. The procedure takes approximately 1.5–2 hours for all 4 eyelids. Most patients return to the hotel the same day." },
  { num: "5", title: "Days 4–5 — Recovery at Hotel", desc: "Rest and light activity. Swelling and bruising begin to resolve. Cold compresses and eye drops as instructed. Your GO is available for any needs throughout." },
  { num: "6", title: "Day 6 — Suture Removal & Departure", desc: "Sutures are removed at your follow-up appointment. You fly home with full aftercare instructions and 12 months of online support from our team." },
];

const recoveryTimeline = [
  { val: "7–10 Days", label: "Comfortable in public" },
  { val: "2–3 Weeks", label: "Return to full activity" },
  { val: "6 Weeks", label: "Majority of swelling resolved" },
...
export default function BlepharoplastyLanding() {
  ...
  const scrollToForm = () => {
    document.getElementById("bleph-form-box")?.scrollIntoView({ behavior: "smooth", block: "start" });
  };
  ...
  const handleEmail = async (e: React.MouseEvent) => {
    ...
    await handleFormspreeSubmit({
      ...
      _subject: `Blepharoplasty Inquiry — Medical Center Turkey`,
      _replyto: form.email,
    } as never);
  };
    ...
    <>
      ...
      <section className="relative min-h-screen flex items-center justify-center text-center px-5 pt-24 pb-36">
        ...
        <div className="relative max-w-4xl mx-auto w-full">
          <div className="inline-block mb-7" style={{ background: "rgba(255,255,255,0.12)", border: "1px solid rgba(255,255,255,0.35)", color: "#fff", fontSize: 12, fontWeight: 600, letterSpacing: 2, textTransform: "uppercase", padding: "8px 18px", borderRadius: 100 }}>
            Istanbul&apos;s Complete Blepharoplasty Experience · Since 2018
          </div>
          <h1 className="font-extrabold leading-tight text-white" style={{ fontSize: "clamp(34px, 6vw, 64px)", lineHeight: 1.1, maxWidth: 820, margin: "0 auto 24px" }}>
            Blepharoplasty <span style={{ color: "#A3C6CF" }}>Turkey.</span><br />
            Refreshed Eyes. From Start to Finish.
          </h1>
          <p style={{ fontSize: "clamp(16px, 2vw, 19px)", color: "rgba(255,255,255,0.75)", maxWidth: 620, margin: "0 auto 44px" }}>
            You fly to Istanbul. We take care of everything else — the surgery, the hotel, the transfers, the aftercare. Upper eyelids, lower eyelids, or all 4 in one procedure.
          </p>
          ...
          <div className="flex justify-center mb-12">
            <svg viewBox="0 0 100 100" width="90" height="90" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M 18 44 Q 35 32 50 32 Q 65 32 82 44" fill="none" stroke="#A3C6CF" strokeWidth="2" strokeLinecap="round" />
              <path d="M 18 44 Q 35 54 50 54 Q 65 54 82 44" fill="rgba(163,198,207,0.12)" stroke="#A3C6CF" strokeWidth="2" strokeLinecap="round" />
              <path d="M 18 60 Q 35 50 50 50 Q 65 50 82 60" fill="none" stroke="#A3C6CF" strokeWidth="2" strokeLinecap="round" />
              <path d="M 18 60 Q 35 70 50 70 Q 65 70 82 60" fill="rgba(163,198,207,0.12)" stroke="#A3C6CF" strokeWidth="2" strokeLinecap="round" />
              <circle cx="50" cy="49" r="5" fill="rgba(163,198,207,0.3)" stroke="#A3C6CF" strokeWidth="1.5" />
              <circle cx="50" cy="49" r="2" fill="#A3C6CF" />
            </svg>
          </div>
          ...
          <div className="flex justify-center gap-8 mt-4 flex-wrap" ref={statsRef}>
            ...
            <div className="text-center">
              <div style={{ fontSize: 30, fontWeight: 800, color: "#A3C6CF" }}>5</div>
      ...
      <section style={{ background: "#fff", padding: "80px 20px" }}>
        <div style={{ maxWidth: 960, margin: "0 auto" }}>
          <div className="text-center mb-4">
            ...
            <p style={{ fontSize: 16, color: "#6B7C8D", maxWidth: 560, margin: "0 auto 52px" }}>Fixed, transparent pricing. Upper, lower, or all 4 eyelids. No hidden costs.</p>
          </div>
      ...
      <section style={{ background: "#fff", padding: "80px 20px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          <h2 style={{ fontSize: "clamp(26px,4vw,42px)", fontWeight: 800, color: "#053980", lineHeight: 1.2, marginBottom: 14 }}>6 Days. Refreshed for Life.</h2>
      ...
      <section style={{ background: "#F4F8FB", padding: "80px 20px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          <p style={{ fontSize: 16, color: "#6B7C8D", maxWidth: 560, marginBottom: 52 }}>Unprompted reviews from patients who trusted us with their blepharoplasty in Istanbul.</p>
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-start">
            ...
            <div>
              ...
              <p style={{ fontSize: 15, color: "rgba(255,255,255,0.55)", marginBottom: 32 }}>The most common questions from our international blepharoplasty patients — answered honestly.</p>
            ...
            {/* Right — Form */}
            <div id="bleph-form-box" style={{ background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.12)", borderRadius: 16, overflow: "hidden", scrollMarginTop: "80px" }}>
              <div id="consultation" />
                ...
                <form style={{ padding: 32, display: "flex", flexDirection: "column", gap: 16 }} onSubmit={e => e.preventDefault()}>
                  ...
                  <div>
                    ...
                    <select value={form.pkg} onChange={e => setForm({ ...form, pkg: e.target.value })}
                      ...
                      <option value="Premium Package — 2 Eyelids — From €1,600" style={{ color: "#000" }}>Premium Package — 2 Eyelids — From €1,600</option>
                      <option value="Hassle-Free Package — 4 Eyelids — From €2,100" style={{ color: "#000" }}>Hassle-Free Package — 4 Eyelids — From €2,100</option>
                      <option value="Executive Package — From €3,200" style={{ color: "#000" }}>Executive Package — From €3,200</option>
