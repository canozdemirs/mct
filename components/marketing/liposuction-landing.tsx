...
const packages = [
  {
    ...
    cta: "outline",
    inclusions: [
      "Liposuction Surgery (Up to 3 Areas)",
...
const faqs = [
  {
    q: "What is included in the Medical Center Turkey liposuction package?",
  ...
  },
  {
    ...
    a: "Our Premium Package starts from €2,500 and covers the surgery, hospital stay, anaesthesia and compression garment. The Hassle-Free Package is €2,900 and adds 5 nights hotel, private transfers, and a dedicated coordinator. The Executive Package is €3,900 and includes 5-star accommodation and the full Istanbul VIP experience.",
  },
  {
    q: "Which body areas can be treated with liposuction?",
    a: "Our packages cover up to 3 body areas per procedure. The most commonly treated areas include the abdomen, flanks (love handles), thighs (inner and outer), upper arms, back, chest, and chin/neck. Your surgeon will confirm the final treatment plan during your pre-operative consultation, based on your goals and anatomy.",
  },
  {
    q: "How many days do I need to stay in Istanbul for liposuction?",
  ...
  {
    q: "Is liposuction in Turkey safe?",
  ...
  {
    q: "What is the recovery process after liposuction?",
    a: "Most patients experience swelling, bruising, and mild discomfort for the first 1–2 weeks. You should avoid strenuous activity for 4–6 weeks and wear your compression garment consistently during this period. Swelling gradually subsides over 3–6 months as your final result becomes visible. We provide 12 months of online aftercare support to monitor your progress.",
  },
  {
  ...
  {
    q: "When will I see my final liposuction result?",
    a: "You will notice an immediate change in shape after surgery, but swelling obscures the final result for several weeks. At 6–8 weeks, the majority of swelling has resolved. Your final result is typically fully visible at 3–6 months. Results are permanent as long as a stable weight is maintained — fat cells removed by liposuction do not return.",
  },
];
...
const trustBlocks = [
  ...
  },
  {
    ...
    desc: "We work exclusively with board-certified plastic surgeons with extensive body contouring experience for international patients.",
  },
];
...
const whyMCT = [
  ...
  { icon: "⚡", title: "Up to 3 Areas Included", desc: "Target multiple problem areas in a single procedure — abdomen, flanks, thighs, arms and more." },
  { icon: "👗", title: "Compression Garment Included", desc: "Your post-operative compression garment is always included — fitted and explained before you leave the hospital." },
...
const journeySteps = [
  { num: "1", title: "Free Online Consultation", desc: "Tell us your target areas via WhatsApp or the form. We review your case, recommend a package, and answer every question — at no cost." },
  ...
  { num: "3", title: "Day 2 — Pre-Op Consultation", desc: "Full examination, blood tests, and treatment areas finalised with your board-certified plastic surgeon." },
  { num: "4", title: "Day 3 — Surgery", desc: "Liposuction performed under general anaesthesia. You stay one night in hospital for post-operative monitoring. Your GO stays with you throughout." },
  ...
  { num: "6", title: "Days 5–6 — Recovery at Hotel", desc: "Rest, light activity, swelling begins to resolve. Your GO is available for any questions or needs throughout." },
  { num: "7", title: "Return Home & Ongoing Support", desc: "Fly home confidently with full aftercare instructions. 12 months of online aftercare support from our team." },
];

const recoveryTimeline = [
  { val: "1 Week", label: "Return to light activity" },
  { val: "4–6 Weeks", label: "Compression garment period" },
  { val: "3 Months", label: "Majority of swelling resolved" },
...
export default function LiposuctionLanding() {
  ...
  const scrollToForm = () => {
    document.getElementById("lipo-form-box")?.scrollIntoView({ behavior: "smooth", block: "start" });
  };
  ...
  const handleEmail = async (e: React.MouseEvent) => {
    ...
    await handleFormspreeSubmit({
      ...
      _subject: `Liposuction Inquiry — Medical Center Turkey`,
      _replyto: form.email,
    } as never);
  };
    ...
    <>
      ...
      <section className="relative min-h-screen flex items-center justify-center text-center px-5 pt-24 pb-36">
        ...
        <div className="relative max-w-4xl mx-auto w-full">
          <div className="inline-block mb-7" style={{ background: "rgba(255,255,255,0.12)", border: "1px solid rgba(255,255,255,0.35)", color: "#fff", fontSize: 12, fontWeight: 600, letterSpacing: 2, textTransform: "uppercase", padding: "8px 18px", borderRadius: 100 }}>
            Istanbul&apos;s Complete Liposuction Experience · Since 2018
          </div>
          <h1 className="font-extrabold leading-tight text-white" style={{ fontSize: "clamp(34px, 6vw, 64px)", lineHeight: 1.1, maxWidth: 820, margin: "0 auto 24px" }}>
            Liposuction <span style={{ color: "#A3C6CF" }}>Turkey.</span><br />
          ...
          <p style={{ fontSize: "clamp(16px, 2vw, 19px)", color: "rgba(255,255,255,0.75)", maxWidth: 620, margin: "0 auto 44px" }}>
            You fly to Istanbul. We take care of everything else — the surgery, the hotel, the transfers, the aftercare. Up to 3 body areas in one procedure.
          </p>
          ...
          <div className="flex justify-center mb-12">
            <svg viewBox="0 0 100 100" width="90" height="90" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M 35 20 Q 32 35 32 50 Q 32 65 36 78" stroke="#A3C6CF" strokeWidth="2" strokeLinecap="round" fill="none" />
              <path d="M 65 20 Q 68 35 68 50 Q 68 65 64 78" stroke="#A3C6CF" strokeWidth="2" strokeLinecap="round" fill="none" />
              <path d="M 35 20 Q 50 16 65 20" stroke="#A3C6CF" strokeWidth="1.5" strokeLinecap="round" fill="none" />
              <path d="M 36 78 Q 50 82 64 78" stroke="#A3C6CF" strokeWidth="1.5" strokeLinecap="round" fill="none" />
              <path d="M 32 50 Q 50 44 68 50" stroke="rgba(163,198,207,0.5)" strokeWidth="1.2" strokeDasharray="3 3" fill="none" />
              <circle cx="26" cy="50" r="3" fill="#A3C6CF" opacity="0.6" />
              <circle cx="74" cy="50" r="3" fill="#A3C6CF" opacity="0.6" />
            </svg>
          </div>
          ...
          <div className="flex justify-center gap-8 mt-4 flex-wrap" ref={statsRef}>
            ...
            <div className="text-center">
              <div style={{ fontSize: 30, fontWeight: 800, color: "#A3C6CF" }}>3</div>
              <div style={{ fontSize: 12, color: "rgba(255,255,255,0.55)", marginTop: 4 }}>Areas Included</div>
            </div>
            <div className="text-center">
      ...
      <section style={{ background: "#fff", padding: "80px 20px" }}>
        <div style={{ maxWidth: 960, margin: "0 auto" }}>
          <div className="text-center mb-4">
            ...
            <p style={{ fontSize: 16, color: "#6B7C8D", maxWidth: 560, margin: "0 auto 52px" }}>Fixed, transparent pricing. Up to 3 areas per procedure. No hidden costs.</p>
          </div>
      ...
      <section style={{ background: "#fff", padding: "80px 20px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          <h2 style={{ fontSize: "clamp(26px,4vw,42px)", fontWeight: 800, color: "#053980", lineHeight: 1.2, marginBottom: 14 }}>6 Days. Life-Changing Results.</h2>
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-start">
            ...
            <div>
              ...
              <p style={{ fontSize: 15, color: "rgba(255,255,255,0.55)", marginBottom: 32 }}>The most common questions from our international liposuction patients — answered honestly.</p>
            ...
            {/* Right — Form */}
            <div id="lipo-form-box" style={{ background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.12)", borderRadius: 16, overflow: "hidden", scrollMarginTop: "80px" }}>
              <div id="consultation" />
                ...
                <form style={{ padding: 32, display: "flex", flexDirection: "column", gap: 16 }} onSubmit={e => e.preventDefault()}>
                  ...
                  <div>
                    ...
                    <select value={form.pkg} onChange={e => setForm({ ...form, pkg: e.target.value })}
                      ...
                      <option value="Hassle-Free Package — From €2,900" style={{ color: "#000" }}>Hassle-Free Package — From €2,900</option>
                      <option value="Executive Package — From €3,900" style={{ color: "#000" }}>Executive Package — From €3,900</option>
                  ...
                  <div>
                    ...
                    <textarea rows={3} placeholder="Tell us which areas you would like to target, or ask any questions..." value={form.message} onChange={e => setForm({ ...form, message: e.target.value })}
