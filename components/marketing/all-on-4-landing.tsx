...
const trustBlocks = [
  ...
  },
  {
    ...
    desc: "Every All-on-4 procedure comes with an official written warranty certificate — your guarantee that we stand behind every result we deliver.",
  },
];
...
const testimonials = [
  {
    ...
    text: "I travelled from the US specifically because I trusted the Medical Center Turkey team. From the first WhatsApp message to landing back home with fixed teeth, every single step was taken care of. I cannot recommend them highly enough.",
  },
  {
    name: "Patient — United Kingdom",
    source: "Trustpilot · GB · Placeholder",
    text: "The GO coordinator was with me every day. I never once felt lost or confused. The surgery itself was completely pain-free and the results are exactly what I was told to expect. I left Istanbul with a new smile and I could not be happier.",
  },
  {
    name: "Patient — Canada",
    source: "Google Review · CA · Placeholder",
    text: "I had been putting this off for years. Medical Center Turkey made the entire process feel simple and safe. The hotel, the transfers, the hospital — all world-class. The price compared to Canada was extraordinary.",
  },
];
