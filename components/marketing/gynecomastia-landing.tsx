...
const packages = [
  {
    ...
    cta: "outline",
    inclusions: [
      "Gynecomastia Surgery (Liposuction + Gland Removal)",
      "Pre-Op Blood Tests & Examination",
      "General Anaesthesia",
      "1 Night Hospital Stay (Post-Op)",
      "Post-Op Medication & Compression Vest",
...
const faqs = [
  {
    q: "What is included in the Medical Center Turkey gynecomastia package?",
  ...
  {
    q: "How much does gynecomastia surgery cost in Turkey with Medical Center Turkey?",
  ...
  {
    q: "What does gynecomastia surgery involve?",
    a: "Gynecomastia surgery combines two techniques to achieve a flat, masculine chest contour. First, liposuction removes excess fatty tissue from the chest area. Then, where necessary, the surgeon removes the firm glandular tissue through a small incision around the areola. The combination of both techniques produces the most natural and complete result. Your surgeon will determine the exact approach during your pre-operative consultation.",
  },
  {
    q: "How many days do I need to stay in Istanbul for gynecomastia surgery?",
  ...
  {
    q: "Is gynecomastia surgery in Turkey safe?",
  ...
  {
    q: "When will I see my final gynecomastia result?",
    a: "You will notice an immediate improvement in chest shape after surgery, but swelling obscures the final result for several weeks. At 6–8 weeks, the majority of swelling has resolved and the chest contour begins to look natural. Your final result is typically fully visible at 3–6 months.",
  },
];
...
const journeySteps = [
  ...
  { num: "3", title: "Day 2 — Pre-Op Consultation", desc: "Full examination, blood tests, and surgical plan finalised with your board-certified plastic surgeon." },
  { num: "4", title: "Day 3 — Surgery", desc: "Gynecomastia surgery performed under general anaesthesia. You stay one night in hospital for post-operative monitoring. Your GO stays with you throughout." },
  { num: "5", title: "Day 4 — Hospital Discharge", desc: "Post-op check, discharge from hospital. Your GO accompanies you back to your hotel. Compression vest fitted and instructions provided." },
...
const recoveryTimeline = [
  ...
  { val: "4–6 Weeks", label: "Compression vest period" },
    ...
    <>
      ...
      <section className="relative min-h-screen flex items-center justify-center text-center px-5 pt-24 pb-36">
        ...
        <div className="relative max-w-4xl mx-auto w-full">
          <div className="inline-block mb-7" style={{ background: "rgba(255,255,255,0.12)", border: "1px solid rgba(255,255,255,0.35)", color: "#fff", fontSize: 12, fontWeight: 600, letterSpacing: 2, textTransform: "uppercase", padding: "8px 18px", borderRadius: 100 }}>
            Istanbul&apos;s Complete Gynecomastia Experience · Since 2018
          </div>
          <h1 className="font-extrabold leading-tight text-white" style={{ fontSize: "clamp(34px, 6vw, 64px)", lineHeight: 1.1, maxWidth: 820, margin: "0 auto 24px" }}>
            Gynecomastia Surgery <span style={{ color: "#A3C6CF" }}>Turkey.</span><br />
          ...
          <p style={{ fontSize: "clamp(16px, 2vw, 19px)", color: "rgba(255,255,255,0.75)", maxWidth: 620, margin: "0 auto 44px" }}>
            You fly to Istanbul. We take care of everything else — the surgery, the hotel, the transfers, the aftercare. Liposuction and gland removal combined in one procedure.
          </p>
          ...
          <div className="flex justify-center mb-12">
            <svg viewBox="0 0 100 100" width="90" height="90" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M 22 52 Q 22 40 30 37 Q 38 34 42 42 Q 44 38 50 37 Q 56 38 58 42 Q 62 34 70 37 Q 78 40 78 52 Q 78 62 68 65 Q 60 67 50 65 Q 40 67 32 65 Q 22 62 22 52 Z" fill="rgba(163,198,207,0.15)" stroke="#A3C6CF" strokeWidth="1.8" strokeLinejoin="round" />
              <line x1="50" y1="37" x2="50" y2="65" stroke="rgba(163,198,207,0.4)" strokeWidth="1.2" strokeDasharray="3 3" />
              <circle cx="37" cy="52" r="3.5" fill="rgba(163,198,207,0.3)" stroke="#A3C6CF" strokeWidth="1.2" />
              <circle cx="63" cy="52" r="3.5" fill="rgba(163,198,207,0.3)" stroke="#A3C6CF" strokeWidth="1.2" />
            </svg>
          </div>
      ...
      <section style={{ background: "#fff", padding: "80px 20px" }}>
        <div style={{ maxWidth: 960, margin: "0 auto" }}>
          <div className="text-center mb-4">
            ...
            <p style={{ fontSize: 16, color: "#6B7C8D", maxWidth: 560, margin: "0 auto 52px" }}>Fixed, transparent pricing. Liposuction and gland removal included. No hidden costs.</p>
          </div>
      ...
      <section style={{ background: "#F4F8FB", padding: "80px 20px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          <p style={{ fontSize: 16, color: "#6B7C8D", maxWidth: 560, marginBottom: 52 }}>Unprompted reviews from patients who trusted us with their gynecomastia surgery in Istanbul.</p>
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-start">
            ...
            <div>
              ...
              <p style={{ fontSize: 15, color: "rgba(255,255,255,0.55)", marginBottom: 32 }}>The most common questions from our international gynecomastia patients — answered honestly.</p>
            ...
            {/* Right — Form */}
            <div id="gyn-form-box" style={{ background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.12)", borderRadius: 16, overflow: "hidden", scrollMarginTop: "80px" }}>
              <div id="consultation" />
                ...
                <form style={{ padding: 32, display: "flex", flexDirection: "column", gap: 16 }} onSubmit={e => e.preventDefault()}>
                  ...
                  <div>
                    ...
                    <select value={form.pkg} onChange={e => setForm({ ...form, pkg: e.target.value })}
                      ...
                      <option value="Premium Package — From €2,200" style={{ color: "#000" }}>Premium Package — From €2,200</option>
                      <option value="Hassle-Free Package — From €2,700" style={{ color: "#000" }}>Hassle-Free Package — From €2,700</option>
                      <option value="Executive Package — From €3,800" style={{ color: "#000" }}>Executive Package — From €3,800</option>
